...
.stApp {
    padding-top: 100px;
    padding-bottom: 100px; /* Kept padding to ensure space for the larger chat input */
}
/* Ensure the chat input stays at the bottom and is centered with increased size */
div[data-testid="stChatInput"] {
    position: fixed !important;
    bottom: 20px !important; /* Adjusted to fit above any potential bottom bar */
    left: 50% !important;
    transform: translateX(-50%) !important; /* Center horizontally */
    width: 80% !important; /* Kept increased width for a larger search bar */
    max-width: 1000px !important; /* Kept increased max-width */
    z-index: 998 !important;
    background-color: #ffffff !important;
    padding: 12px 24px !important; /* Kept padding for better appearance */
...
/* Revert login button styling to original */
...
def create_prompt(user_question):
    ...
    specific_keywords = ["metric", "describe", "reports", "fact", "Explain", "logic", "behind","Available","display","document"]
...
if not st.session_state.authenticated:
    ...
    # Place the logo only in the authenticated section (welcome page)
    st.markdown(
        f'<img src="https://dilytics.com/wp-content/uploads/2022/11/logo.png" class="dilytics-logo">',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        ...
        <div class="fixed-header">
            <h1 style='color: #29B5E8; margin-bottom: 5px;'>Cortex AI-PBCS Assistant by DiLytics</h1>
            <p style='font-size: 16px; color: #333;'><strong>Welcome to Cortex AI. I am here to help with Dilytics PBCS Insights Solutions</strong></p>
        </div>
        """,
        unsafe_allow_html=True
    )
